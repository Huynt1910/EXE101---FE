export function PaymentCard() {
  ...
  return (
    <section className="rounded-tl-4xl rounded-bl-4xl bg-background p-5 shadow-sm md:p-6">
      ...
      <div className="mt-4 grid grid-cols-2 gap-2">
        {paymentBrands.map((brand) => (
          <div
            key={brand}
            className="type-body-sm flex h-12 items-center justify-center rounded-xl border border-border bg-background font-medium text-foreground"
          >
            {brand}
          </div>
        ))}
