...
function deriveEventCount(matchScore: number) {
  // simulate "300+ events" label from score
  if (matchScore >= 90) return "500+";
  if (matchScore >= 75) return "300+";
  if (matchScore >= 60) return "150+";
  return "50+";
}
...
type TripRequestsGridProps = {
  ...
  onApplyContact: (requestId: string) => void;
};
