...
const testimonials = [
  ...
  {
    quote:
      "A true revolution for my gut health. Biometic probiotics have transformed my daily well-being.",
    author: "Lucas P.",
  ...
  {
    quote:
      "Biometic helped me regain restorative sleep. I finally wake up rested and full of energy.",
    author: "Claire B.",
...
export function TestimonialsSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="temoignages"
      className="py-24 bg-background overflow-hidden lg:py-32 lg:pb-0"
    >
      {/* Section Header */}
